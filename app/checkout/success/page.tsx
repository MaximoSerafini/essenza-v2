...
function SuccessContent() {
  ...
  const handleConfirmPurchase = () => {
    const phoneNumber = '549' + '3794222701' // Argentina + número
    const message = `Hola! 👋 He completado mi pago en Essenza.%0A%0ADetalles de la compra:%0AID de preferencia: ${preferenceId || 'N/A'}%0A%0APor favor, confirmar la compra y coordinar los detalles del envío/retiro. ¡Gracias!`
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-8">
        <div className="text-center mb-6">
          ...
          <p className="mt-2 text-gray-600">Tu pago fue procesado correctamente</p>
        </div>

        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
          <p className="text-sm text-gray-700">
            <strong>Gracias por tu compra.</strong> Nos comunicaremos contigo próximamente para confirmar los detalles del envío o coordinar el retiro.
          </p>
        </div>
