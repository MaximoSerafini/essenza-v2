...
function PendingContent() {
  ...
  const handleContactSupport = () => {
    ...
    const message = `Hola! 👋 Mi pago en Essenza está pendiente.%0A%0ADetalles:%0AID de preferencia: ${preferenceId || 'N/A'}%0A%0APor favor, ayudame a resolver esto. ¡Gracias!`
      ...
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-8">
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-yellow-100 rounded-full mb-4">
            <svg className="w-8 h-8 text-yellow-600 animate-spin" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" />
            </svg>
          </div>
          <h1 className="text-3xl font-bold text-gray-900">Pago pendiente</h1>
          <p className="mt-2 text-gray-600">Estamos procesando tu pago</p>
        </div>

        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
          <p className="text-sm text-gray-700">
            <strong>Tu pago está siendo procesado.</strong> Te notificaremos cuando sea confirmado. Esto puede tomar unos minutos.
          </p>
        </div>
