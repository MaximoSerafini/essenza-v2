...
const perfumes: Perfume[] = [
  ...
  // Nuevos perfumes agregados
  {
    id: 84,
    marca: "Tubbees",
    nombre: "Cookies & Cream 100ml EDP",
  ...
  },
  {
    id: 85,
    marca: "Tubbees",
    nombre: "Sweet Caramel 100ml EDP",
  ...
  },
  {
    id: 94,
    marca: "Maison Alhambra",
    nombre: "Jean Lowe Immortal 100ml EDP",
    imagen: "/placeholder.svg",
    precio: 44000,
    notas: {
  ...
  },
  {
    id: 95,
    marca: "Maison Alhambra",
    nombre: "Glacier Pour Homme 100ml EDP",
    imagen: "/placeholder.svg",
    precio: 43000,
    notas: {
  ...
  },
  {
    ...
    genero: "Mujer",
    fragancia_referencia: "Estilo Victoria’s Secret",
    descripcion: "Alegre, juvenil y chispeante, como un body splash glam con estela.",
    rating: 4.6,
    sinDescuento: false,
  },
  {
    ...
    genero: "Mujer",
    fragancia_referencia: "J’adore – Dior (dupe)",
    descripcion: "Homenaje floral elegante y romántico; radiante y femenino.",
    rating: 4.7,
    sinDescuento: false,
  },
  {
    ...
    genero: "Hombre",
    fragancia_referencia: "Y – Yves Saint Laurent",
    descripcion: "Moderna y energizante, con fondo cálido; versátil todo el año.",
    rating: 4.7,
    sinDescuento: false,
  },
  {
    ...
    genero: "Mujer",
    fragancia_referencia: "Very Good Girl Glam – Carolina Herrera",
    descripcion: "Atrevida, sofisticada y adictiva; tu mejor accesorio de noche.",
    rating: 4.7,
    sinDescuento: false,
  },
  {
    ...
    descripcion: "Versátil, vibrante y seductora; fresca cítrica con corazón especiado.",
    rating: 4.8,
    sinDescuento: false,
  },
  {
    id: 103,
    marca: "Zakat",
    nombre: "Victorioso Heroic 100ml EDP",
    imagen: "/placeholder.svg",
    precio: 50000,
    notas: {
      salida: ["Cítricos", "especias aromáticas"],
      corazon: ["Flores exóticas", "resinas"],
      fondo: ["Oud", "ámbar", "almizcle", "maderas"],
    },
    genero: "Hombre",
    fragancia_referencia: "Birds of Paradise For Him – Carolina Herrera",
    descripcion: "Opulento y memorable; estela intensa y refinada de poder y carácter.",
    rating: 4.7,
    sinDescuento: false,
  },
  {
    id: 104,
    marca: "Lattafa Perfumes",
    nombre: "Asad (Black) 100ml EDP",
    imagen: "/placeholder.svg",
    precio: 45000,
    notas: {
      salida: ["Pimienta negra", "tabaco", "piña"],
      corazon: ["Pachulí", "café", "iris"],
      fondo: ["Vainilla", "ámbar", "madera seca", "benjuí", "ládano"],
    },
    genero: "Hombre",
    fragancia_referencia: "Sauvage – Dior (estilo oscuro)",
    descripcion: "Fuerte y seductor; ideal para la noche, días fríos y gran duración.",
    rating: 4.8,
    sinDescuento: false,
  },
  {
  ...
  },
  {
    ...
    genero: "Mujer",
    fragancia_referencia: "",
    descripcion: "Fragancia femenina elegante y versátil.",
    rating: 4.6,
    sinDescuento: false,
  },
  {
